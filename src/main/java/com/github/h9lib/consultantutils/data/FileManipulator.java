...
import com.github.h9lib.consultantutils.annotations.data.file.excel.XlsxExcel;
...
public final class FileManipulator {
	 ...
	 *
	 * @param <T> The parametrized object wo which you want to create the list to inject into Excel
	 ...
	 * @throws MissingAnnotationException | Exception
	 * @throws IOException | Exception
	 * @throws NoSuchFieldException | Exception
	 * @throws SecurityException | Exception
	 */
	public static <T> String generateExcelAsBase64(List<T> obj, Class<T> clazz) throws IllegalArgumentException, IllegalAccessException, MissingAnnotationException, IOException, NoSuchFieldException, SecurityException {
		Workbook workbook = clazz.getAnnotation(XlsxExcel.class).isXlsxExcel()
				? new XSSFWorkbook()
				: new HSSFWorkbook();
	 ...
	 * @throws SecurityException | Exception
	 */
	public static <T> byte[] generateExcelAsByteArray(List<T> obj, Class<T> clazz) throws IllegalArgumentException, IllegalAccessException, MissingAnnotationException, IOException, NoSuchFieldException, SecurityException {
		Workbook workbook = clazz.getAnnotation(XlsxExcel.class).isXlsxExcel()
				? new XSSFWorkbook()
				: new HSSFWorkbook();
	...
	private static <T> void generateExcel(List<T> obj, Workbook workbook, Class<T> clazz) throws IllegalArgumentException, MissingAnnotationException, IllegalAccessException, NoSuchFieldException, SecurityException {
		...
		if(!(clazz.isAnnotationPresent(ToExcel.class) && clazz.getAnnotation(ToExcel.class).exportToExcel())) {
			...
			if(!clazz.isAnnotationPresent(XlsxExcel.class))
